...
const techStack = ["SAP S/4HANA","SAP BTP","SAP Integration Suite","SAP Analytics Cloud","ABAP","SAP Fiori","SAPUI5","SAP ECC","SAP SuccessFactors","SAP Ariba"];
export default function SAPPage() {
  const { lang } = useLanguage();
  const p = t[lang].sapPage;
  return (
    <>
      <Header />
