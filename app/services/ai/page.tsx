...
const techStack = ["Python","PyTorch","TensorFlow","Hugging Face","LangChain","OpenAI API","Azure OpenAI","MLflow","Vertex AI","Kubeflow"];
export default function AIPage() {
  const { lang } = useLanguage();
  const p = t[lang].aiPage;
  return (
    <>
      <Header />
      <main className="flex-1">
        ...
        <section className="bg-[#1B2B5E] px-6 py-20">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <a href="/contact" className="mt-8 inline-block rounded-xl bg-[#E8231A] px-8 py-3.5 text-sm font-semibold text-white hover:bg-[#C41C14] transition-colors">{p.ctaWorkshop}</a>
          </div>
        </section>
      </main>
      <Footer />
